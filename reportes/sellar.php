...
<script type="text/javascript">
function name_file() {
document.getElementById("fileUpload").name = "fileUpload"; 
}
</script>
<script>
function evento_file(){
...
<body id="tsa" onload="name_file();evento_file();">
    <main>
        <div>
            <section>
                <div>
    ...
    <form action="agregar.php" enctype="multipart/form-data" name="formulario" method="POST">
        <p>
            ...
            <tr>
            <td>            
            <input class="btn_finalizar" type="submit" value="Finalizar" onclick="listAttributes();">
